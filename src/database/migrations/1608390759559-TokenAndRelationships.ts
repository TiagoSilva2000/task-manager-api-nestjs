...
export class TokenAndRelationships1608390759559 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "token" ("id" SERIAL NOT NULL, "token" character varying(255) NOT NULL, "token_type" character varying(30) NOT NULL DEFAULT 'jwt', "is_revoked" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT 'now()', "user_id" integer, CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "task" ALTER COLUMN "updated_at" SET DEFAULT 'now()'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "users"."email" IS NULL`);
        await queryRunner.query(`ALTER TABLE "task" ALTER COLUMN "updated_at" SET DEFAULT '2020-12-17 22:47:05.758006'`);
        await queryRunner.query(`COMMENT ON COLUMN "task"."updated_at" IS NULL`);
        await queryRunner.query(`ALTER TABLE "task" ALTER COLUMN "created_at" SET DEFAULT '2020-12-17 22:47:05.758006'`);
        await queryRunner.query(`COMMENT ON COLUMN "task"."created_at" IS NULL`);
